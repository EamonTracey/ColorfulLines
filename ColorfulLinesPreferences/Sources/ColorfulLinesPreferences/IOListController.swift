...
class IOListController: PSListController {
    ...
    let prefsPath = "/User/Library/Preferences/com.eamontracey.colorfullinespreferences.plist"
    ...
    override func setPreferenceValue(_ value: Any!, specifier: PSSpecifier!) {
        ...
        CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFNotificationName("com.eamontracey.colorfullinespreferences/update" as CFString), nil, nil, true)
    }
